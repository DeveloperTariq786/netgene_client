...
import { BrandMegaMenuSkeleton } from './skeletons/BrandMegaMenuSkeleton';

const BrandMegaMenu = () => {
    const { data: brands, isLoading, error } = useBrands();

    return (
        <div className="w-full bg-gradient-to-br from-white via-gray-50 to-white p-8 shadow-2xl rounded-b-2xl border-t-2 border-emerald-100 min-h-[200px] flex flex-col justify-center">
            {isLoading ? (
                <BrandMegaMenuSkeleton />
            ) : error ? (
