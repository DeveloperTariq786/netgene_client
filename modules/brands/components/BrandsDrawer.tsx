...
import { X, ChevronRight, Store, Search, Loader2 } from 'lucide-react';
import { useBrands } from '../hooks/useBrands';
import { BrandDrawerSkeleton } from './skeletons/BrandDrawerSkeleton';
    ...
    return (
        <>
            ...
            >
                ...
                <div className="flex flex-col bg-white border-b border-gray-100 pt-5 pb-3 px-5 shadow-sm">
                    ...
                    <div className="relative">
                        <input
                            ...
                            disabled={isLoading}
                            className="w-full bg-gray-100 text-sm text-gray-700 rounded-lg pl-9 pr-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 transition-all placeholder:text-gray-400 disabled:opacity-50"
                        />
                ...
                {/* Brands List */}
                <div className="flex-1 overflow-y-auto scrollbar-hide p-4 space-y-3 flex flex-col">
                    {isLoading ? (
                        <BrandDrawerSkeleton />
                    ) : error ? (
                        <div className="text-center py-10">
                            <p className="text-sm font-medium text-red-500">Failed to load brands</p>
                        </div>
                    ) : (
                        <>
